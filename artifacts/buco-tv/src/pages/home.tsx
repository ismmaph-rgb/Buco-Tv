import { useListChannels, useListCategories, useListFeaturedChannels } from "@workspace/api-client-react";
...
export function Home() {
  ...
  const { data: featured = [], isLoading: loadingFeatured } = useListFeaturedChannels();
    ...
    <div className="min-h-screen bg-background text-foreground pb-20">
      ...
      <main>
        ...
        <div className="container mx-auto px-4 space-y-12">
          ...
          {/* Categories Rows */}
          {!loadingCategories && !loadingChannels && categories.map(category => {
              ...
              <section key={category}>
                ...
                <div className="flex overflow-x-auto pb-4 -mx-4 px-4 gap-4 snap-x hide-scrollbar">
                  {categoryChannels.map(channel => (
                    <div key={channel.id} className="min-w-[240px] sm:min-w-[280px] w-[240px] sm:w-[280px] flex-shrink-0 snap-start">
          ...
          {(loadingCategories || loadingChannels) && (
